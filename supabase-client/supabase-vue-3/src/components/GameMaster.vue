<template>
  <div>
    <input id="gameId" type="text" v-model="state.gameId" />
    <button type="button" @click="requestGame"
    ...
    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
      Create game</button>
    <textarea id="guildMessage" v-model="state.guildMessage">
    </textarea>
...
export default {
  ...
  setup() {
    ...
    let seeds = {
      ...
      cosmicDeck: '../seeds/encounter-deck.json',
